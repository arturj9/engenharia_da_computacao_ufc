...
public class PainelTabuleiro extends Painel{
	...
	private class Mover implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Robo robo = janela.getPainelTabuleiro().getPlano().getRoboSelecionado();
			if(janela.getPainelTabuleiro().getPlano().verificaRoboSelecionado()) {
				robo.movimentar(botaoCelula.getCelula());
				atualizar();
				janela.getPainelMenu().atualizar();
			}else {
				JOptionPane.showMessageDialog(getJanela(), "Selecione um robô", "Aviso",
