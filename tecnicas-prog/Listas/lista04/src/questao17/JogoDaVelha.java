...
public class JogoDaVelha {
	...
	public boolean verificarVitoria(Jogador jogador, int linha, int coluna) {
		...
		if (this.verificaVitoriaLinha(simbolo, linha) || this.verificaVitoriaColuna(simbolo, coluna)
				|| this.verificaVitoriaDiagonalPrincipal(simbolo) || this.verificaVitoriaDiagonalSecundaria(simbolo))
			return true;
		return false;
	}
